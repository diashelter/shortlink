...
export class CreateLinksTable1784033656648 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f5e434d70a12e8e6544fdbda8b" ON "links" ("shortCode") `);
        await queryRunner.query(`CREATE INDEX "IDX_links_user_active" ON "links" ("userId") WHERE "status" = 'ACTIVE'`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_links_user_destination" ON "links" ("userId", "destinationUrl") `);
        await queryRunner.query(`CREATE INDEX "IDX_links_user_created_at_id" ON "links" ("userId", "createdAt", "id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_links_user_created_at_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f5e434d70a12e8e6544fdbda8b"`);
